...
<template>
  <div
    class="group mb-6 cursor-pointer overflow-hidden rounded-2xl border border-secondary duration-200 hover:-translate-y-2 hover:shadow-xl sm:flex lg:mb-0 lg:block lg:w-[350px]"
  >
