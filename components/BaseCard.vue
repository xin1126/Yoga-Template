...
<template>
  <div>
    <div
      class="group mb-6 cursor-pointer overflow-hidden rounded-2xl border-secondary hover:-translate-y-2 hover:shadow-xl sm:flex lg:mb-0 lg:block lg:w-[350px]"
      :class="
    ...
    <div
      v-show="$store.state.course === data.title && !isHome"
      class="mt-8 hidden text-center lg:block"
    >
